      ...
      <div class="inner-container">
        <div style="display: flex; align-items: center;gap: 10px;">
            <div>
                <input
                type="search"
                on:input={() => searchInput(event.target.value)}
                />
            </div>
            <div>
            ...
            <!-- <tr>
                {#each Object.entries(searchParams) as [key, value]}
                    <td>
                        <input
                            type="search"
                            bind:value={searchParams[key]}
                            on:input={handleSearch(key, event.target.value)}
                        />
                    </td>
                {/each}
            </tr> -->
             <tr>
                ...
                {#if isDropdownOpen[1]}
                  <div style="position: absolute;">    
                    <div on:click={() => toggleDropdown(1)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                  ...
                  /> 
                    <div class="options-container">
                        {#each uniqueResponseValues.msisdn as msisdn_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('msisdn', msisdn_values)} checked={selectedCheckboxes['msisdn'] && selectedCheckboxes['msisdn'].includes(msisdn_values)}/>
                              {msisdn_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                   {#if isDropdownOpen[2]}
                    <div style="position: absolute;">   
                      <div on:click={() => toggleDropdown(2)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>                
                      <input
                    type="search"
                  ...
                  />
                      ...
                      <div class="options-container">
                        {#each uniqueResponseValues.source_ip as source_ip_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('source_ip', source_ip_values)} checked={selectedCheckboxes['source_ip'] && selectedCheckboxes['source_ip'].includes(source_ip_values)}/>
                              {source_ip_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[3]}
                    <div style="position: absolute;">  
                      <div on:click={() => toggleDropdown(3)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>                   
                      <input
                    type="search"
                  ...
                  />
                      <div class="options-container">
                        {#each uniqueResponseValues.source_port as source_port_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('source_port', source_port_values)} checked={selectedCheckboxes['source_port'] && selectedCheckboxes['source_port'].includes(source_port_values)}/>
                              {source_port_values}
                            </li>
                          </ul>
                        {/each}
               ...
               <td>
                  {#if isDropdownOpen[4]}
                    <div style="position: absolute;"> 
                      <div on:click={() => toggleDropdown(4)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                        type="search"
                      ...
                      <div class="options-container">
                        {#each uniqueResponseValues.destination_ip as destination_ip_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('destination_ip', destination_ip_values)} checked={selectedCheckboxes['destination_ip'] && selectedCheckboxes['destination_ip'].includes(destination_ip_values)} />
                ...
                <td>
                  {#if isDropdownOpen[5]}
                    <div style="position: absolute;">   
                      <div on:click={() => toggleDropdown(5)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>                 
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.destination_port as destination_port_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('destination_port', destination_port_values)} checked={selectedCheckboxes['destination_port'] && selectedCheckboxes['destination_port'].includes(destination_port_values)} />
                ...
                <td>
                  {#if isDropdownOpen[6]}
                    <div style="position: absolute;">  
                      <div on:click={() => toggleDropdown(6)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.cell_id as cell_id_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('cell_id', cell_id_values)} checked={selectedCheckboxes['cell_id'] && selectedCheckboxes['cell_id'].includes(cell_id_values)}  />
                              {cell_id_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[7]}
                    <div style="position: absolute;">    
                      <div on:click={() => toggleDropdown(7)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>                
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.company as company_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('company', company_values)} checked={selectedCheckboxes['company'] && selectedCheckboxes['company'].includes(company_values)} />
                              {company_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[8]}
                    <div style="position: absolute;"> 
                      <div on:click={() => toggleDropdown(8)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>                  
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.domain as domain_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('domain', domain_values)} checked={selectedCheckboxes['domain'] && selectedCheckboxes['domain'].includes(domain_values)} />
                              {domain_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[9]}
                    <div style="position: absolute;">
                      <div on:click={() => toggleDropdown(9)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.service as service_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('service', service_values)}  checked={selectedCheckboxes['service'] && selectedCheckboxes['service'].includes(service_values)}/>
                              {service_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[10]}
                    <div style="position: absolute;">
                      <div on:click={() => toggleDropdown(10)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.time as time_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('time', time_values)} checked={selectedCheckboxes['time'] && selectedCheckboxes['time'].includes(time_values)} />
                ...
                <td>
                  {#if isDropdownOpen[11]}
                    <div style="position: absolute;">
                      <div on:click={() => toggleDropdown(11)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.time_et as time_et_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('time_et', time_et_values)} checked={selectedCheckboxes['time_et'] && selectedCheckboxes['time_et'].includes(time_et_values)} />
                ...
                <td> 
                  {#if isDropdownOpen[12]}
                    <div style="position: absolute;">  
                      <div on:click={() => toggleDropdown(12)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.duration as duration_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('duration', duration_values)} checked={selectedCheckboxes['duration'] && selectedCheckboxes['duration'].includes(duration_values)} />
                              {duration_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[13]}
                    <div style="position: absolute;"> 
                      <div on:click={() => toggleDropdown(13)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.uplink_vol as uplink_vol_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('uplink_vol', uplink_vol_values)} checked={selectedCheckboxes['uplink_vol'] && selectedCheckboxes['uplink_vol'].includes(uplink_vol_values)} />
                              {uplink_vol_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[14]}
                    <div style="position: absolute;">
                      <div on:click={() => toggleDropdown(14)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.downlink_vol as downlink_vol_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('downlink_vol', downlink_vol_values)} checked={selectedCheckboxes['downlink_vol'] && selectedCheckboxes['downlink_vol'].includes(downlink_vol_values)} />
                              {downlink_vol_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[15]}
                    <div style="position: absolute;">
                      <div on:click={() => toggleDropdown(15)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>   
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.com_type as com_type_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('com_type', com_type_values)} checked={selectedCheckboxes['com_type'] && selectedCheckboxes['com_type'].includes(com_type_values)} />
                              {com_type_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[16]}
                    <div style="position: absolute;"> 
                      <div on:click={() => toggleDropdown(16)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.roaming as roaming_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('roaming', roaming_values)} checked={selectedCheckboxes['roaming'] && selectedCheckboxes['roaming'].includes(roaming_values)} />
                              {roaming_values}
                            </li>
                          </ul>
                        {/each}
                ...
                <td>
                  {#if isDropdownOpen[17]}
                    <div style="position: absolute;"> 
                      <div on:click={() => toggleDropdown(17)} style="cursor:pointer; display: flex; justify-content: flex-end;">
                        <img src="close.svg" alt="close">
                      </div>
                      <input
                      type="search"
                    ...
                    />
                      <div class="options-container">
                        {#each uniqueResponseValues.provider as provider_values}
                          <ul class="list-style">
                            <li>
                              <input type="checkbox" on:change={() => handleCheckboxSelection('provider', provider_values)} checked={selectedCheckboxes['provider'] && selectedCheckboxes['provider'].includes(provider_values)} />
                ...
                {#if isDropdownOpen[1]}
                  <div style="position: absolute;">    
                    ...
                    <input
                      type="search" 
                      value={enterValue}       
                      on:input={() => handleSearch(event.target.value)}                                  
                    />
                    <div class="options-container">
                      {#each uniqueResponseValues.msisdn as values}
                        <ul class="list-style">
                          <li>
                            <input type="checkbox" on:change={() => handleCheckboxSelection(values)} checked={isChecked} />
                            {values}
                          </li>
                        </ul>
                      {/each}
                ...
                <td>  
                    {#if isDropdownOpen[2]}
                      <div style="position: absolute;">    
                        ...
                        />
                        <div class="options-container">
                          {#each uniqueResponseValues.source_ip as sourceIP, index}
                            <ul class="list-style">
                              <li>
                                <input type="checkbox" on:change={() => handleCheckboxSelection(values)} checked={isChecked} />
                                {sourceIP}
                    ...
                    <td>  
                        {#if isDropdownOpen[3]}
                          <div style="position: absolute;">    
                            ...
                            /> a
                            <div class="options-container">
                              {#each uniqueResponseValues.source_port as values}
                                <ul class="list-style">
                                  <li>
                                    <input type="checkbox" on:change={() => handleCheckboxSelection(values)} checked={isChecked} />
                                    {values}
